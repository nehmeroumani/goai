...
GoAI is a Go SDK that provides one unified API across 25+ LLM providers. This document describes the overall architecture, key layers, data flow, and design decisions.
...
HTTP error response
  ...
  │   ├─ IsOverflow(message) — matches 14 regex patterns across 25+ providers
